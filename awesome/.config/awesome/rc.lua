...
local scrlocker    = "i3lock-fancy-multimonitor -n -b=5x8"
local screenshot   = "flameshot gui -p " .. os.getenv("HOME") .. "/Pictures/screenshot"
local screenshot_full   = "flameshot full -p " .. os.getenv("HOME") .. "/Pictures/screenshot"
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, }, "Print", function() os.execute(screenshot) end,
              {description = "take a screenshot (fullscreen)", group = "hotkeys"}),
  ...
  awful.key(
    ...
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute(string.format("amixer -q set %s 1+ toggle", beautiful.volume.channel))
            beautiful.volume.update()
        end,
  ...
  -- More media keys - rebind useless keys on laptop to function as media keys
  -- Play/Pause 
   awful.key({ },
    "XF86Tools",
     function ()
  ...
  -- Power Menu
  awful.key({ modkey }, "p", function () awful.spawn.with_shell("~/.config/awesome/powermenu.sh") end,
